...
public class CinPostRequest extends Thread {
    private final Logger LOG = Logger.getLogger(CinPostRequest.class.getName());
    private IReceived receiver;
    private String cnt_name = "";
    private Context context;

    public ContentInstanceObject contentInstance;
    public CinPostRequest(Context context, String cnt_name, String con){
